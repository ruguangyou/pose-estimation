...
class LIB_API PointCloudReading {
    ...
    public:
        ...
        inline PointCloudReading& typeOfVerticalAngularLayout(const uint8_t &v) noexcept {
            m_typeOfVerticalAngularLayout = v;
            return *this;
        }
        inline uint8_t typeOfVerticalAngularLayout() const noexcept {
            return m_typeOfVerticalAngularLayout;
        }
...
//            visitor.preVisit(ID(), ShortName(), LongName());
            ...
            if (6 == fieldId) {
                doVisit(6, std::move("uint8_t"s), std::move("typeOfVerticalAngularLayout"s), m_typeOfVerticalAngularLayout, visitor);
                return;
            }
...
//            visitor.postVisit();
        ...
        inline void accept(PreVisitor &&preVisit, Visitor &&visit, PostVisitor &&postVisit) {
            ...
            doTripletForwardVisit(6, std::move("uint8_t"s), std::move("typeOfVerticalAngularLayout"s), m_typeOfVerticalAngularLayout, preVisit, visit, postVisit);
    ...
    private:
        ...
        uint8_t m_typeOfVerticalAngularLayout{ 0 }; // field identifier = 6.
